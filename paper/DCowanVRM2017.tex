...
Das2004, Druyts2009, Lee1984, Das2006} are both complicated and lack 
...
frequency-dependent \cite{Lee1984,Dabas1992,Fannin1995}:
\begin{equation}
...
(4.88) in \cite{Ward1988}, for a circular transmitter loop with
...
respectively. Note that we are neglecting the primary field contributions for equations found in \cite{Ward1988}.
...
\cite{vanDam2004,vanDam2005,Druyts2009}; as such, the magnetic
...
response \cite{Billings2003,Druyts2009,Das2006}. Some have suggested that
...
observations made by \cite{vanDam2004, vanDam2005,Druyts2009,
