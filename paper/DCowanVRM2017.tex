...
%In this paper,
%expressions for the transient VRM response, generated by a large
%circular loop over a conductive and magnetically viscous half-space,
%are derived for a step-off excitation. Because the magnetic
%susceptibilities of lateritic soils are sufficiently small,
%inductive and VRM responses are considered separable, and the
%effects of self-demagnetization are ignored. The VRM response is
%derived by solving integral equations for the magnetostatic response
%before the step-off excitation, then using the after-effect
%functions derived by N\'{e}el for a collection of non-interacting
%superparamagnetic grains. Results are verified using the EM1DTM
%forward modeling code, developed by the University of British
%Columbia Geophysical Inversion Facility, and show excellent
%agreement. Both the vertical and horizontal components of the VRM
%response show little spatial variation near the loop's center, but
%increase rapidly in magnitude towards the edges of the loop. Near
%the transmitter loop's center, VRM responses are inversely
%proportional to the transmitter radius, whereas inductive responses
%are proportional to the radius squared. Results indicate that
%sensors which measure B(t) directly are impacted by the VRM response
%at much earlier times than sensors which measure dB/dt.
...
%\textcolor{red}{directly from Hankel transform solutions found in
%Ward and Hohmann by taking their limits as $\omega \rightarrow 0$;
%Eqs. (4.87) and (4.88) in \cite{Ward1987}. For a transmitter loop of
%radius $a$, at height $h$ above the surface,
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.50\textwidth]{imagesColor/figElliptic.png}
...
\begin{figure}[!b]
\centering
\includegraphics[width=0.50\textwidth]{imagesColor/figHankelJ1J1Int.png}
...
\begin{figure}[!b]
    \centering
    \vspace{-10pt}
    \subfloat[]{\includegraphics[width=0.37\textwidth]{imagesColor/figVRMrespBz.png}
    \label{figVRMrespBz}}\\
    \vspace{-10pt}
    \subfloat[]{\includegraphics[width=0.37\textwidth]{imagesColor/figVRMrespdBzdt.png}
...
\begin{figure}[!h]
    \centering
    \vspace{-10pt}
    \subfloat[]{\includegraphics[width=0.40\textwidth]{imagesColor/figVRMrespBcoin.png}
    \label{figVRMrespBzcoin}}\\
    \vspace{-10pt}
    \subfloat[]{\includegraphics[width=0.40\textwidth]{imagesColor/figVRMrespdBdtcoin.png}
...
\begin{figure}[!t]
    \centering
    \subfloat[]{\includegraphics[width=0.4\textwidth]{imagesColor/figVRMrespBrho.png}
    \label{figVRMrespBrho}}\\
    \vspace{-10pt}
    \subfloat[]{\includegraphics[width=0.4\textwidth]{imagesColor/figVRMrespdBrhodt.png}
...
\begin{figure}[!t]
    \centering
    \vspace{-10pt}
    \subfloat[]{\includegraphics[width=0.24\textwidth]{imagesColor/figBzAdditive.png}
    \label{figBzAdditive}}
    \subfloat[]{\includegraphics[width=0.24\textwidth]{imagesColor/figBrhoAdditive.png}
    \label{figBrhoAdditive}}\\
    \subfloat[]{\includegraphics[width=0.24\textwidth]{imagesColor/figdBzdtAdditive.png}
    \label{figdBzdtAdditive}}
    \subfloat[]{\includegraphics[width=0.24\textwidth]{imagesColor/figdBrhodtAdditive.png}
...
\centering
\vspace{-10pt}
\includegraphics[width=0.48\textwidth]{imagesColor/figW.png}
...
\begin{figure}[!b]
    \centering
    \vspace{-15pt}
    \subfloat[]{\includegraphics[width=0.45\textwidth]{imagesColor/figEMandVRMrespBzCenterLoops.png}
    \label{figRespBzLoops}}\\
    \vspace{-10pt}
    \subfloat[]{\includegraphics[width=0.45\textwidth]{imagesColor/figEMandVRMrespdBzdtCenterLoops.png}
...
\begin{figure}[!t]
    \centering
    \subfloat[]{\includegraphics[width=0.45\textwidth]{imagesColor/figEMandVRMrespBzOffAxis.png}
    \label{figEMandVRMoffaxisBz}}\\
    \vspace{-10pt}
    \subfloat[]{\includegraphics[width=0.45\textwidth]{imagesColor/figEMandVRMrespdBzdtOffAxis.png}
